    ...
    <div class="container max-w-screen-xl mx-auto px-6 md:px-12 xl:px-24 text-white">
      <div class="lg:flex lg:gap-4 lg:justify-between min-h-screen">
        ...
        <div class="lg:w-1/2 lg:py-24 py-16">
          <h4 class="font-Inter-bold text-xl text-white sticky top-0 lg:static py-4 bg-slate-900/50 backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none z-20 mb-2">About</h4>
          ...
          <h4 class="font-Inter-bold text-xl text-white sticky top-0 lg:static py-4 bg-slate-900/50 backdrop-blur-sm lg:bg-transparent lg:backdrop-blur-none z-20 mb-2">Experience</h4>
